<%-- 
    ...
    Created on : 28 may. 2023, 3:00:53
    Author     : JOSE
--%>
...
<html>
    <head>
        ...
        <link href="css/style.css" rel="stylesheet"><title>NiSi Shop</title>
        <!-- Favicon -->
        <link href="img/dress.png" rel="icon">
    ...
    <body>
        ...
        <div class="container-fluid">
                    ...
                    <div class="d-inline-flex align-items-center">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <button class="dropdown-item" type="button">Registrarme</button>
                            </div>
                        </div>
            ...
            <div class="row align-items-center bg-light py-2 px-xl-4 d-none d-lg-flex">
                <div class="col-lg-4">
                    <a href="" class="text-decoration-none"><img src="img/Nisi.jpg" width="150" class="my-1">
                    </a>
                </div>
                        ...
                        <div class="navbar-nav w-100">
                            <div class="nav-item dropdown dropright">
                                ...
                                <div class="dropdown-menu position-absolute rounded-0 border-0 m-0">
                                    <a href="" class="dropdown-item">Ropa de Hombres</a>
                                    <a href="" class="dropdown-item">Ropa de Mujeres</a>
                ...
                <div class="col-lg-9">
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                        <a href="" class="text-decoration-none d-block d-lg-none">
                            <span class="h1 text-uppercase text-dark bg-light px-2">NiSi</span>
                            <span class="h1 text-uppercase text-light bg-primary px-2 ml-n1">Moda</span>
                        </a>
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                                <a class="nav-item nav-link active" href="Controlador?accion=home">Inicio</a>
                                <a href="#" class="nav-item nav-link">Tienda</a>
                                <a href="#" class="nav-item nav-link">Detalles de Compra</a>
            ...
            <div class="row px-xl-5">
                <div class="col-12">
                    <nav class="breadcrumb bg-light mb-30">
                        <a class="breadcrumb-item text-dark" href="Controlador?accion=home">Inicio</a>
            ...
            <div class="row px-xl-5">
                    ...
                    <table class="table table-light table-borderless table-hover text-center mb-0">
                        ...
                        <tbody class="align-middle">
                            <c:forEach var="car" items="${carrito}">
                                <tr>
                                    <td>${car.getItem()}</td>
                                    <td class="">  <img class="img-circle profile_img" src="Controlador_IMG?id=${car.getIdProducto()}" style="width: 50px;"/><span class="float-right">${car.getNombres()}</span></td>  
                                 
                            
                                    <td>${car.getDescripcion()}</td> 
                                    <td><div class="input-group quantity mx-auto" style="width: 100px;">
                                            <div class="input-group-btn">
                                                <button class="btn btn-sm btn-primary btn-minus" >
                                                    <i class="fa fa-minus"></i>
                                                </button>
                                            </div>
                                            <input type="text" class="form-control form-control-sm bg-secondary border-0 text-center" value="${car.getCantidad()}">
                                            <div class="input-group-btn">
                ...
                <div class="col-lg-4">
                    <form class="mb-30" action="">
                        <div class="input-group">
                            <input type="text" class="form-control border-0 p-4" placeholder="Código Coupon ">
                            <div class="input-group-append">
                                <button class="btn btn-primary">Aplica Coupon</button>
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="bg-light p-30 mb-5">
                        ...
                        <div class="pt-2">
                            ...
                            <button class="btn btn-block btn-primary font-weight-bold my-3 py-3">Pasar por la Caja</button>
                        </div>
                    </div>
                </div>
            </div>

<%-- 
    Document   : index.jsp
    Created on : 21-may-2023, 15:15:21
    Author     : JOSE
--%>
        ...
        <div class="row px-xl-5 pb-3">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center bg-light mb-4" style="padding: 30px;">
                    ...
                    <h5 class="font-weight-semi-bold m-0">Devolución hasta 14 días</h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center bg-light mb-4" style="padding: 30px;">
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            <c:forEach var="p" items="${productos}">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 pb-1 position-relative">
                    <div class="product-item bg-light mb-4">
                        <div class="card w-100"">
                            ...
                            <div class="card-body text-center py-4">
                                <label class="h6 text-decoration-none text-truncate text-center" >${p.getNombres()}</label>
                                <label class="card-text text-center">${p.getDescripcion()}</label>
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5>${p.getPrecio()}</h5><h6 class="text-muted ml-2"><del>$123.00</del></h6>
                                </div>

                        ...
                        <div class="card"> 
                            <div class="card-header m-0 p-0">
                                <div class="product-img position-relative overflow-hidden ">
                                    <img class="img-fluid w-100 h-100"  src="Controlador_IMG?id=${p.getId()}" alt="">
                            ...
                            <div class="card">
                                <div class="card-header m-o">
                                    <div class="text-center py-4">
                                        <label class="h6 text-decoration-none text-truncate" >${p.getNombres()}</label>
                                        <label class="text" ><p style="text-align: center">${p.getDescripcion()}</p></label>
